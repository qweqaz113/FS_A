...
from enterprise_agent.benchmarks.co2full.paths import (
    DEFAULT_DB_ROOT,
    DEFAULT_PAIR_CSV,
    report_path_for,
)
from enterprise_agent.benchmarks.co2full.runner import compare_co2full_row
...
def main(
    ...
    *,
    ...
    _apply_args(
        _parse_args(
            argv,
            default_trace_dir=Path(default_trace_dir) if default_trace_dir is not None else None,
...
def _parse_args(
    ...
    *,
    ...
    parser.add_argument(
        ...
        required=default_trace_dir is None,
    )
    parser.add_argument(
        "--report-dir",
        type=Path,
