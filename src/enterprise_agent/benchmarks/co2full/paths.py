...
DATASET_DIR = PROJECT_ROOT / "datasets" / "co2full"
DEFAULT_DB_ROOT = DATASET_DIR / "raw"
...
def trace_path_for(pair_key: str, trace_dir: str | Path) -> Path:
    return result_path_for(pair_key, trace_dir)


def report_path_for(pair_key: str, report_dir: str | Path) -> Path:
