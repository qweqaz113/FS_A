...
SOURCE_RUN_DIR = PROJECT_ROOT / "experiments" / "main_agent" / "runs" / "paper_initial"
REPORT_DIR = SOURCE_RUN_DIR / "report"
TRACE_DIR = SOURCE_RUN_DIR / "trace"
DB_ROOT = DEFAULT_DB_ROOT
CSV_PATH = DEFAULT_PAIR_CSV
OUTPUT_DIR = EXPERIMENT_DIR / "runs" / "default" / "error_analysis"
