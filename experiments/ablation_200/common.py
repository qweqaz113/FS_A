...
from enterprise_agent.benchmarks.co2full.paths import DEFAULT_DB_ROOT, DEFAULT_PAIR_CSV

EXPERIMENT_DIR = Path(__file__).resolve().parent
ROOT_DIR = EXPERIMENT_DIR.parents[1]
ABLATION_DIR = EXPERIMENT_DIR / "runs" / "default"
SUBSET_CSV = ABLATION_DIR / "subset.csv"
SUBSET_JSON = ABLATION_DIR / "subset_summary.json"

INITIAL_RUN_DIR = ROOT_DIR / "experiments" / "main_agent" / "runs" / "paper_initial"
REFINED_RUN_DIR = ROOT_DIR / "experiments" / "refined_agent" / "runs" / "default"
INITIAL_PREDICTIONS = INITIAL_RUN_DIR / "evaluation" / "predictions.csv"
REFINED_PREDICTIONS = REFINED_RUN_DIR / "evaluation" / "predictions.csv"
INITIAL_REPORT_DIR = INITIAL_RUN_DIR / "report"
REFINED_REPORT_DIR = REFINED_RUN_DIR / "report"
